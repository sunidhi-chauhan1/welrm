                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td><span style="font-size: 14px;">Thanks Vikram! <br><strong>Your booking in Kiesdffv is
                                        confirmed.</strong></span></td>
                        </tr>

                        <td><span style="font-size: 14px;"><strong>Gar'is Kyiv Factory Hostel</strong> is expecting you on
                                <strong>14 June</strong></span></td>
        </tr>
        <tr>

            <td><span style="font-size: 14px;">Your <strong>payment</strong> will be handled by Gar'is Kyiv Factory
                    Hostel. The '<strong>Payment</strong>' section below has more details</span></td>
        </tr>
        <tr>
