...
@section('content')
                        ...
                        <div class="Hotel_info_container" id="hotel">
                            <div class="Rooms_location">
                                <div class="Check_container">
                                    <div>
                                        <input type="radio" name="inputGrp" id="Hello" onclick="showBothDivs()"
                                            checked />
                                ...
                                <div class="City_details_cards">
                                    <div class="Location_input">
                                        <input type="text" class="form-control city_input"
                                            placeholder="Enter City name, Location or Specific hotel" name="" />
                                    </div>
                                ...
                                <div class="Rooms_card">
                                    ...
                                    <div class="select_rooms">
                                        ...
                                        <div>
                                            ...
                                            <p><span id="adultCount">2</span> Adults | <span id="childCount">0</span> Child
                                                | <span id="roomCount">1</span> Room</p>
                                        </div>
                                    </div>
                                    <div class="Room_dropdwon" id="Home_Room_booking">
                                        <div class="Room_drop_card">
                                            <div class="Room">
                                                ...
                                                <div class="Count">
                                                    <ion-icon name="remove-circle-outline" role="img"
                                                        class="md hydrated dec"></ion-icon>
                                                    <p>2</p>
                                                    <ion-icon name="add-circle-outline" role="img"
                                                        class="md hydrated inc">
                                                    </ion-icon>
                                                </div>
                                            </div>
                                            <div class="Room">
    ...
    <!--
                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                     <li>Access our best insider and VIP deals</li>
                                                                                                                                                                                                                                                                                     <li>Earn AgodaCash to save even more</li>
                                                                                                                                                                                                                                                                                     <li>Collect bookings towards your next VI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    </div> -->
    ...
    <script>
        window.onload = (event) => {
            const Rooms_card_p = document.querySelector('.Rooms_card p');
    ...
    <script>
        ...
        var incrementButton = document.getElementsByClassName('dec');
