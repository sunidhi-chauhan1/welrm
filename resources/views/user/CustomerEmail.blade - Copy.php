    ...
    <table style="    width: 600px;
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td><span style="font-size: 14px;">Thanks Vikram! <br><strong>Your booking in Kiefdfv is
                                    confirmed.</strong></span>
                        </td>
                    </tr>
                    <tr>
                        <td><span style="font-size: 14px;"><strong>Gar'is Kyiv Factory Hostel</strong> is expecting you on
                                <strong>14 June</strong></span>
                        </td>
                    </tr>
                    <tr>
                        <td><span style="font-size: 14px;">Your <strong>payment</strong> will be handled by Gar'is Kyiv Factory
                                Hostel. The '<strong>Payment</strong>' section below has more details</span>
                        </td>
                    </tr>
                    <tr>
                        <td><span style="font-size: 14px; display: table;">Make changes to your booking or ask the property a
                                question in just a few
                                clicks</span>
                        </td>
                    </tr>
                </table>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <th style="text-align: left; padding: 3px;"> 4200123456</th>
                        </tr>
                        <tr>
                            <th style="text-align: left;  padding: 3px;">Check In:</th>
                            <td style="text-align: left;  padding: 3px;">March 17, 2023</td>
                        </tr>
                        <tr>
                            <th style="text-align: left;  padding: 3px;">Check Out:</th>
                            <td style="text-align: left;  padding: 3px;">March 18, 2023</td>
                        </tr>
                    </tbody>
                </table>
            </td>
                ...
                <table style="margin-bottom: 10px;">
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: left; padding: 3px;">Welrm </td>
                        </tr>
                        <tr>
                            <th style="text-align: left; padding: 3px;">Address: </th>
                            <td style="text-align: left; padding: 3px;">opposite Sr. Sec. School, Ghanauli, Singhpura, Punjab 140113 </td>
                        </tr>
                        <tr>
                            <th style="text-align: left; padding: 3px;">Phone: </th>
                            <td style="text-align: left; padding: 3px;">+91-9584290842 </td>
                        </tr>
                        <tr>
                            <th style="text-align: left; padding: 3px;">Email: </th>
                            <td style="text-align: left; padding: 3px;">info@welrm.com</td>
                        </tr>
                    </tbody>
                </table>
            </td>
        ...
        <tr>
            <td align="center" valign="top">
                <ul class="icons-ul" style="justify-content:center; margin: 0px; list-style-type: none;padding: 0;display: inline-flex;">
                    <li class="icons-li" style="margin: 0 7px;"><a href=""><img src="./images/icons/Youtube.ico" width="28" alt="icon"></a></li>
                    <li class="icons-li" style="margin: 0 7px;"><a href=""><img src="./images/icons/instagram.ico" width="28" alt="icon"></a></li>
                    <li class="icons-li" style="margin: 0 7px;"><a href=""><img src="./images/icons/facebook.ico" width="28" alt="icon"></a></li>
                    <li class="icons-li" style="margin: 0 7px;"><a href=""><img src="./images/icons/twitter.ico" width="28" alt="icon"></a></li>
                    <li class="icons-li" style="margin: 0 7px;"><a href=""><img src="./images/icons/linkedin.ico" width="28" alt="icon"></a></li>
                </ul>
            </td>
        </tr>
        <tr>
