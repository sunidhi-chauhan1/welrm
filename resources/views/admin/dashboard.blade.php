...
@section('content')
    ...
    {{-- <div class="main-content">
        <div class="dashboard-breadcrumb mb-30">
            ...
            <div class="btn-box">
                <a href="dashboard.dashboard-all-product.html" class="btn btn-sm btn-primary">View All</a>
            </div>
        </div>
        <div class="row g-4">
                        ...
                        <nav>
                            <div class="btn-box d-flex flex-wrap gap-1 mb-30" id="nav-tab" role="tablist">
                                ...
                                <button class="btn btn-sm btn-outline-primary" id="nav-shipping-info-tab"
                                    ...
                                    aria-controls="nav-shipping-info" aria-selected="false">Shipping
                                    info</button>
                        ...
                        <div class="tab-content product-data-tab" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-inventory" role="tabpanel"
                                ...
                                <form>
                                    ...
                                    <div class="row align-items-center g-3 mb-3">
                                        <label class="col-md-2 col-form-label col-form-label-sm">Sold individually
                                ...
                                <form>
                                    ...
                                    <div class="row align-items-center g-3 mb-3">
                                        <label for="freeShipping"
                                            class="col-md-2 col-8 col-form-label col-form-label-sm">Free
                                            Shipping</label>
                                        <div class="col-md-10 col-4">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                ...
                                <form>
                                    ...
                                    <div class="row align-items-center g-3 mb-3">
                                        <label for="todaysDeal"
                                            class="col-md-2 col-8 col-form-label col-form-label-sm">Today's
                                            Deal</label>
                                        <div class="col-md-10 col-4">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
