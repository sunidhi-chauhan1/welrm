    ...
    <div class="col-12">
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          @endif
          <form class="forms-sample"  method="POST" action="{{route('admin.policies')}}" enctype="multipart/form-data">
            @csrf
            <div class="container">
              <div class="row">
              <div class="col">
                  ...
                  <div class="form-group row">
                    <label for="exampleInputEmail2">Name of the Policies</label>
                    <div class="form-group row Hotel_owner_content">
                    
                      <input type="text" class="form-control" id="exampleInputMobile" name="policiesName" placeholder="intro content" value="{{$policies->policies}}"></input>
                    </div>
